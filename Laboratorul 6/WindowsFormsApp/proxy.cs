...
namespace Laboratorul_6
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Post", Namespace="http://schemas.datacontract.org/2004/07/Laboratorul_6", IsReference=true)]
    public partial class Post : object, System.Runtime.Serialization.IExtensibleDataObject
    {
        
        private System.Runtime.Serialization.ExtensionDataObject extensionDataField;
        
        private Laboratorul_6.Comment[] CommentsField;
        ...
        public Laboratorul_6.Comment[] Comments
        {
            get
            {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="Comment", Namespace="http://schemas.datacontract.org/2004/07/Laboratorul_6", IsReference=true)]
    public partial class Comment : object, System.Runtime.Serialization.IExtensibleDataObject
    {
        ...
        private Laboratorul_6.Post PostField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Laboratorul_6.Post Post
        {
            get
            {
...
public interface IPostComment
{
    ...
    bool AddPost(Laboratorul_6.Post post);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfacePost/AddPost", ReplyAction="http://tempuri.org/InterfacePost/AddPostResponse")]
    System.Threading.Tasks.Task<bool> AddPostAsync(Laboratorul_6.Post post);
    ...
    Laboratorul_6.Post UpdatePost(Laboratorul_6.Post post);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfacePost/UpdatePost", ReplyAction="http://tempuri.org/InterfacePost/UpdatePostResponse")]
    System.Threading.Tasks.Task<Laboratorul_6.Post> UpdatePostAsync(Laboratorul_6.Post post);
    ...
    Laboratorul_6.Post GetPostById(int id);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfacePost/GetPostById", ReplyAction="http://tempuri.org/InterfacePost/GetPostByIdResponse")]
    System.Threading.Tasks.Task<Laboratorul_6.Post> GetPostByIdAsync(int id);
    ...
    Laboratorul_6.Post[] GetPosts();
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfacePost/GetPosts", ReplyAction="http://tempuri.org/InterfacePost/GetPostsResponse")]
    System.Threading.Tasks.Task<Laboratorul_6.Post[]> GetPostsAsync();
    ...
    bool AddComment(Laboratorul_6.Comment comment);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfaceComment/AddComment", ReplyAction="http://tempuri.org/InterfaceComment/AddCommentResponse")]
    System.Threading.Tasks.Task<bool> AddCommentAsync(Laboratorul_6.Comment comment);
    ...
    Laboratorul_6.Comment UpdateComment(Laboratorul_6.Comment newComment);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfaceComment/UpdateComment", ReplyAction="http://tempuri.org/InterfaceComment/UpdateCommentResponse")]
    System.Threading.Tasks.Task<Laboratorul_6.Comment> UpdateCommentAsync(Laboratorul_6.Comment newComment);
    ...
    Laboratorul_6.Comment GetCommentById(int id);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfaceComment/GetCommentById", ReplyAction="http://tempuri.org/InterfaceComment/GetCommentByIdResponse")]
    System.Threading.Tasks.Task<Laboratorul_6.Comment> GetCommentByIdAsync(int id);
}
...
public partial class PostCommentClient : System.ServiceModel.ClientBase<IPostComment>, IPostComment
{
    ...
    public bool AddPost(Laboratorul_6.Post post)
    {
        return base.Channel.AddPost(post);
    }
    
    public System.Threading.Tasks.Task<bool> AddPostAsync(Laboratorul_6.Post post)
    {
        return base.Channel.AddPostAsync(post);
    }
    
    public Laboratorul_6.Post UpdatePost(Laboratorul_6.Post post)
    {
        return base.Channel.UpdatePost(post);
    }
    
    public System.Threading.Tasks.Task<Laboratorul_6.Post> UpdatePostAsync(Laboratorul_6.Post post)
    {
    ...
    public Laboratorul_6.Post GetPostById(int id)
    {
        return base.Channel.GetPostById(id);
    }
    
    public System.Threading.Tasks.Task<Laboratorul_6.Post> GetPostByIdAsync(int id)
    {
        return base.Channel.GetPostByIdAsync(id);
    }
    
    public Laboratorul_6.Post[] GetPosts()
    {
        return base.Channel.GetPosts();
    }
    
    public System.Threading.Tasks.Task<Laboratorul_6.Post[]> GetPostsAsync()
    {
        return base.Channel.GetPostsAsync();
    }
    
    public bool AddComment(Laboratorul_6.Comment comment)
    {
        return base.Channel.AddComment(comment);
    }
    
    public System.Threading.Tasks.Task<bool> AddCommentAsync(Laboratorul_6.Comment comment)
    {
        return base.Channel.AddCommentAsync(comment);
    }
    
    public Laboratorul_6.Comment UpdateComment(Laboratorul_6.Comment newComment)
    {
        return base.Channel.UpdateComment(newComment);
    }
    
    public System.Threading.Tasks.Task<Laboratorul_6.Comment> UpdateCommentAsync(Laboratorul_6.Comment newComment)
    {
        return base.Channel.UpdateCommentAsync(newComment);
    }
    
    public Laboratorul_6.Comment GetCommentById(int id)
    {
        return base.Channel.GetCommentById(id);
    }
    
    public System.Threading.Tasks.Task<Laboratorul_6.Comment> GetCommentByIdAsync(int id)
    {
